...
PROJECT_NAME = "Mus3D" 			    	#项目名称
VERSION = "1.0"  						#打包版本号 会根据不同的版本创建文件夹（与项目本身的版本号无关）
...
OUTPUT = "/Users/wyb/Desktop/%s" %(CONFIGURATION) #打包导出ipa文件路径（请确保 “%s” 之前的文件夹正确并存在）
...
USER_KEY = "d67ca8b2db0bad1e6bc711544490cf25"
API_KEY = "1baf405055dcd9a0be2b4927b8feaa1f"
